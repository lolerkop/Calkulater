...
const stateScenarios: Record<string, StateScenario> = {
  ...
  'epoxy-volume': { query: { length: 180, width: 70, thickness: 8, density: 1.05, ratio: 4 }, result: { primary: "10,584 кг", rows: [{ label: "Смолы", value: "8,467 кг" }, { label: "Отвердителя", value: "2,117 кг" }, { label: "Объём заливки", value: "10,08 л" }] } },
