...
export const resultPhrases: Record<string, Partial<Record<Locale, string>>> = {
  ...
  'Маржа должна быть меньше 100%': { en: 'The margin must be below 100%', de: 'Die Marge muss unter 100 % liegen', uk: 'Маржа має бути меншою за 100%', es: "El margen debe ser menor del 100 %" },
  'Цена продажи ниже себестоимости, поэтому наценка и маржа отрицательные.': { en: 'The selling price is below the cost, so both markup and margin are negative.', de: 'Der Verkaufspreis liegt unter den Selbstkosten, deshalb sind Aufschlag und Marge negativ.', uk: 'Ціна продажу нижча за собівартість, тому націнка й маржа відʼємні.', es: "El precio de venta está por debajo del coste, así que el marcado y el margen son negativos." },
  'Введите цену больше нуля': { en: 'Enter a price greater than zero', de: 'Trage einen Preis über null ein', uk: 'Введіть ціну більшу за нуль', es: "Introduce un precio mayor que cero" },
  ...
  'Сумма кредита должна быть положительной': { en: 'The loan amount must be greater than zero', de: 'Der Darlehensbetrag muss größer als null sein', uk: 'Сума кредиту має бути більшою за нуль', es: "El importe del préstamo debe ser positivo" },
  'Постоянные затраты не могут быть отрицательными': { en: 'Fixed costs cannot be negative', de: 'Die Fixkosten können nicht negativ sein', uk: 'Постійні витрати не можуть бути відʼємними', es: "Los costes fijos no pueden ser negativos" },
  'Цена продажи должна быть больше нуля': { en: 'The selling price must be greater than zero', de: 'Der Verkaufspreis muss größer als null sein', uk: 'Ціна продажу має бути більшою за нуль', es: "El precio de venta debe ser mayor que cero" },
  'Переменные затраты не могут быть отрицательными': { en: 'Variable costs cannot be negative', de: 'Die variablen Kosten können nicht negativ sein', uk: 'Змінні витрати не можуть бути відʼємними', es: "Los costes variables no pueden ser negativos" },
  'Переменные затраты не ниже цены продажи, поэтому маржинальная прибыль не положительна. При таких условиях увеличение продаж не приводит к безубыточности: сначала нужно поднять цену или снизить переменные затраты.': { en: 'The variable cost is not below the selling price, so the contribution margin is not positive. Under these conditions selling more never reaches break-even: the price has to go up or the variable cost has to come down first.', de: 'Die variablen Kosten liegen nicht unter dem Verkaufspreis, deshalb ist der Deckungsbeitrag nicht positiv. Unter diesen Bedingungen führt mehr Absatz nie zur Gewinnschwelle: zuerst muss der Preis steigen oder die variablen Kosten müssen sinken.', uk: 'Змінні витрати не нижчі за ціну продажу, тому маржинальний прибуток не є додатним. За таких умов збільшення продажів не приводить до беззбитковості: спочатку потрібно підняти ціну або знизити змінні витрати.', es: "Los costes variables no están por debajo del precio de venta, así que el margen de contribución no es positivo. En esas condiciones vender más no alcanza nunca el equilibrio: primero hay que subir el precio o reducir los costes variables." },
  ...
  'Введите положительные размеры стены': { en: 'Enter positive wall dimensions', de: 'Trage positive Wandmaße ein', uk: 'Введіть додатні розміри стіни', es: "Introduce dimensiones positivas del muro" },
  'Введите положительные размеры камня': { en: 'Enter positive unit dimensions', de: 'Trage positive Steinmaße ein', uk: 'Введіть додатні розміри каменю', es: "Introduce dimensiones positivas de la pieza" },
  'Толщина шва не может быть отрицательной': { en: 'The mortar joint cannot be negative', de: 'Die Fugendicke kann nicht negativ sein', uk: 'Товщина шва не може бути відʼємною', es: "El espesor de la junta no puede ser negativo" },
  'Площадь проёмов не может быть отрицательной': { en: 'The area of openings cannot be negative', de: 'Die Fläche der Öffnungen kann nicht negativ sein', uk: 'Площа прорізів не може бути відʼємною', es: "La superficie de los huecos no puede ser negativa" },
  'Запас не может быть отрицательным': { en: 'The waste allowance cannot be negative', de: 'Die Reserve kann nicht negativ sein', uk: 'Запас не може бути відʼємним', es: "La reserva no puede ser negativa" },
  'Проёмы занимают всю стену — кладка не требуется': { en: 'The openings fill the whole wall — there is nothing to build', de: 'Die Öffnungen füllen die ganze Wand — es ist nichts zu mauern', uk: 'Прорізи займають усю стіну — класти нічого', es: "Los huecos ocupan todo el muro: no hace falta fábrica" },
  'Расчёт выполнен для одного слоя кладки по видимой плоскости стены. Кладка в кирпич и толще, перевязка, простенки и доборные элементы не моделируются, поэтому перед закупкой сверьтесь с проектом.': { en: 'The calculation covers a single leaf of masonry measured on the visible face of the wall. Walls one brick thick or more, bonding patterns, piers and special units are not modelled, so check your drawings before ordering.', de: 'Gerechnet ist eine einschalige Wand, gemessen an der sichtbaren Wandfläche. Wände von einem Stein Dicke und mehr, Verband, Pfeiler und Ergänzungssteine werden nicht abgebildet, prüfe vor dem Einkauf also die Planung.', uk: 'Розрахунок виконано для одного шару кладки по видимій площині стіни. Кладка в цеглину й товща, перевʼязка, простінки та добірні елементи не моделюються, тому перед закупівлею звіртеся з проєктом.', es: "El cálculo se ha hecho para una sola hoja de fábrica sobre la cara vista del muro. La fábrica de un pie o más, el aparejo, los machones y las piezas especiales no se modelan, así que contrasta con el proyecto antes de comprar." },
  'сохранённый справочный курс': { en: 'saved reference rate', de: 'gespeicherter Referenzkurs', uk: 'збережений довідковий курс', es: 'tipo de referencia guardado' },
  'Это не курс в реальном времени. Используются сохранённые справочные курсы указанных источников; резервный источник отмечен отдельно. Банки и обменные пункты могут использовать другие курсы и комиссии.': { en: 'These are not real-time rates. The calculation uses saved reference rates from the listed sources; any fallback source is marked separately. Banks and exchange services may use different rates and fees.', de: 'Das sind keine Echtzeitkurse. Verwendet werden gespeicherte Referenzkurse der genannten Quellen; eine Ersatzquelle ist gesondert gekennzeichnet. Banken und Wechselstuben können andere Kurse und Gebühren ansetzen.', uk: 'Це не курс у реальному часі. Використовуються збережені довідкові курси зазначених джерел; резервне джерело позначено окремо. Банки та обмінні сервіси можуть застосовувати інші курси й комісії.', es: 'Estos no son tipos en tiempo real. Se usan tipos de referencia guardados de las fuentes indicadas; cualquier fuente de reserva se señala por separado. Los bancos y las casas de cambio pueden aplicar otros tipos y comisiones.' },
  'Сохранённые курсы прошли последнюю проверку источников.': { en: 'The saved rates passed the latest source check.', de: 'Die gespeicherten Kurse haben die letzte Quellenprüfung bestanden.', uk: 'Збережені курси пройшли останню перевірку джерел.', es: 'Los tipos guardados superaron la última comprobación de fuentes.' },
  'Курсы одного или нескольких источников могут быть устаревшими. Проверьте даты источников.': { en: 'One or more source rates may be stale. Check the source dates.', de: 'Ein oder mehrere Quellkurse könnten veraltet sein. Prüfe die Daten der Quellen.', uk: 'Курси одного або кількох джерел можуть бути застарілими. Перевірте дати джерел.', es: 'Uno o varios tipos pueden estar desactualizados. Comprueba las fechas de las fuentes.' },
  'Последняя проверка источников не удалась. Используются последние сохранённые курсы.': { en: 'The latest source check failed. The last saved rates are being used.', de: 'Die letzte Quellenprüfung ist fehlgeschlagen. Die zuletzt gespeicherten Kurse werden verwendet.', uk: 'Остання перевірка джерел не вдалася. Використовуються останні збережені курси.', es: 'La última comprobación de fuentes falló. Se utilizan los últimos tipos guardados.' },
  'Европейский центральный банк': { en: 'European Central Bank', de: 'Europäische Zentralbank', uk: 'Європейський центральний банк', es: "Banco Central Europeo" },
  'Национальный банк Украины': { en: 'National Bank of Ukraine', de: 'Nationalbank der Ukraine', uk: 'Національний банк України', es: "Banco Nacional de Ucrania" },
  'Национальный банк Молдовы': { en: 'National Bank of Moldova', de: 'Nationalbank der Republik Moldau', uk: 'Національний банк Молдови', es: "Banco Nacional de Moldavia" },
  'Exchange Rate API': { en: 'Exchange Rate API', de: 'Exchange Rate API', uk: 'Exchange Rate API', es: "Exchange Rate API" },
  'Основной источник был недоступен, курс получен из резервного.': { en: 'The primary source was unavailable, so this rate came from the fallback source.', de: 'Die Hauptquelle war nicht erreichbar, der Kurs stammt aus der Ersatzquelle.', uk: 'Основне джерело було недоступне, тому курс отримано з резервного.', es: "La fuente principal no estaba disponible; el tipo se obtuvo de la de reserva." },
  'Сохранённые курсы проверены; часть валют получена из резервного источника.': { en: 'The saved rates were checked; some currencies came from a fallback source.', de: 'Die gespeicherten Kurse wurden geprüft; ein Teil der Währungen stammt aus einer Ersatzquelle.', uk: 'Збережені курси перевірено; частину валют отримано з резервного джерела.', es: 'Se comprobaron los tipos guardados; parte de las monedas procede de una fuente de reserva.' },
  'Доллар США': { en: 'US dollar', de: 'US-Dollar', uk: 'Долар США', es: "Dólar estadounidense" },
  'Евро': { en: 'Euro', de: 'Euro', uk: 'Євро', es: "Euro" },
  'Молдавский лей': { en: 'Moldovan leu', de: 'Moldauischer Leu', uk: 'Молдовський лей', es: "Leu moldavo" },
  'Румынский лей': { en: 'Romanian leu', de: 'Rumänischer Leu', uk: 'Румунський лей', es: "Leu rumano" },
  'Гривна': { en: 'Ukrainian hryvnia', de: 'Hrywnja', uk: 'Українська гривня', es: "Grivna ucraniana" },
  'Польский злотый': { en: 'Polish zloty', de: 'Polnischer Złoty', uk: 'Польський злотий', es: "Esloti polaco" },
  'Фунт стерлингов': { en: 'Pound sterling', de: 'Pfund Sterling', uk: 'Фунт стерлінгів', es: "Libra esterlina" },
  'Швейцарский франк': { en: 'Swiss franc', de: 'Schweizer Franken', uk: 'Швейцарський франк', es: "Franco suizo" },
  'Турецкая лира': { en: 'Turkish lira', de: 'Türkische Lira', uk: 'Турецька ліра', es: "Lira turca" },
  ...
  'Показан размер первого (наибольшего) платежа. Далее платёж снижается.': { en: 'The first and largest payment is shown. Later payments gradually decrease.', de: 'Gezeigt ist die erste und höchste Rate. Danach sinkt die Rate allmählich.', uk: 'Показано перший і найбільший платіж. Наступні платежі поступово зменшуються.', es: "Se muestra el importe de la primera cuota, la mayor. Después la cuota va bajando." },
  'Показан размер первого (наибольшего) платежа.': { en: 'The first and largest payment is shown.', de: 'Gezeigt ist die erste und höchste Rate.', uk: 'Показано перший і найбільший платіж.', es: "Se muestra el importe de la primera cuota, la mayor." },
  ...
  'Показаны первые 12 месяцев и последний платеж.': { en: 'The first 12 months and the final payment are shown.', de: 'Gezeigt sind die ersten 12 Monate und die letzte Rate.', uk: 'Показано перші 12 місяців і останній платіж.', es: "Se muestran los 12 primeros meses y la última cuota." },
  ...
  'Введите положительные размеры': { en: 'Enter positive dimensions', de: 'Trage positive Maße ein', uk: 'Введіть додатні розміри', es: "Introduce dimensiones positivas" },
  ...
  'Неизвестная валюта': { en: 'Unknown currency', de: 'Unbekannte Währung', uk: 'Невідома валюта', es: "Moneda desconocida" },
...
export const resultLabelPhrases: Record<string, Partial<Record<Locale, string>>> = {
  ...
  'Камней без запаса': { en: 'Units without waste', uk: 'Каменів без запасу', de: 'Steine ohne Reserve', es: "Piezas sin reserva" },
  'Расчётный модуль камня': { en: 'Working module per unit', uk: 'Розрахунковий модуль каменю', de: 'Rechenmodul des Steins', es: "Módulo de cálculo de la pieza" },
  'Камней на квадратный метр': { en: 'Units per square metre', uk: 'Каменів на квадратний метр', de: 'Steine je Quadratmeter', es: "Piezas por metro cuadrado" },
  ...
  'Точка безубыточности': { en: 'Break-even point', uk: 'Точка беззбитковості', de: 'Gewinnschwelle', es: "Punto de equilibrio" },
  'Маржинальная прибыль с единицы': { en: 'Contribution margin per unit', uk: 'Маржинальний прибуток з одиниці', de: 'Deckungsbeitrag je Einheit', es: "Margen de contribución por unidad" },
  'Коэффициент маржинальной прибыли': { en: 'Contribution margin ratio', uk: 'Коефіцієнт маржинального прибутку', de: 'Deckungsbeitragsquote', es: "Ratio de margen de contribución" },
  'Расчётный объём без округления': { en: 'Calculated volume before rounding', uk: 'Розрахунковий обсяг без округлення', de: 'Rechnerische Menge ohne Rundung', es: "Volumen calculado sin redondear" },
  'Выручка при расчётном объёме': { en: 'Revenue at the calculated volume', uk: 'Виручка за розрахункового обсягу', de: 'Umsatz bei der rechnerischen Menge', es: "Ingresos al volumen calculado" },
  'Выручка при целом числе единиц': { en: 'Revenue at whole units', uk: 'Виручка за цілого числа одиниць', de: 'Umsatz bei ganzen Einheiten', es: "Ingresos al número entero de unidades" },
  'Выручка при плане продаж': { en: 'Revenue at the planned volume', uk: 'Виручка за планового обсягу', de: 'Umsatz bei der geplanten Menge', es: "Ingresos al plan de ventas" },
  'Маржинальная прибыль при плане': { en: 'Contribution at the planned volume', uk: 'Маржинальний прибуток за планом', de: 'Deckungsbeitrag bei der geplanten Menge', es: "Margen de contribución del plan" },
  'Прибыль при плане': { en: 'Profit at the planned volume', uk: 'Прибуток за планом', de: 'Gewinn bei der geplanten Menge', es: "Beneficio del plan" },
  'Запас прочности': { en: 'Margin of safety', uk: 'Запас міцності', de: 'Sicherheitsspanne', es: "Margen de seguridad" },
  'Запас прочности, %': { en: 'Margin of safety, %', uk: 'Запас міцності, %', de: 'Sicherheitsspanne, %', es: "Margen de seguridad, %" },
  ...
  'Итоговая сумма': { en: 'Final amount', uk: 'Підсумкова сума', de: 'Endbetrag', es: "Importe final" },
  'Начисленные проценты': { en: 'Interest earned', uk: 'Нараховані відсотки' },
  'Сумма пополнений': { en: 'Total contributions', uk: 'Сума поповнень' },
  'Внесённая сумма': { en: 'Invested amount', uk: 'Внесена сума', de: 'Eingezahlter Betrag', es: "Importe aportado" },
  'Прибыль': { en: 'Profit', uk: 'Прибуток', de: 'Gewinn', es: "Beneficio" },
  'Сумма кредита': { en: 'Loan amount', uk: 'Сума кредиту', de: 'Darlehensbetrag', es: "Importe del préstamo" },
  'Общая стоимость с взносом': { en: 'Total cost with down payment', uk: 'Загальна вартість із внеском', de: 'Gesamtkosten samt Anzahlung', es: "Coste total con la entrada" },
  'Общая стоимость': { en: 'Total cost', uk: 'Загальна вартість', de: 'Gesamtkosten', es: "Coste total" },
  'Цена со скидкой': { en: 'Discounted price', uk: 'Ціна зі знижкою', de: 'Preis nach Rabatt', es: "Precio con descuento" },
  'Размер скидки': { en: 'Discount amount', uk: 'Розмір знижки', de: 'Rabattbetrag', es: "Importe del descuento" },
  'Процент скидки': { en: 'Discount percentage', uk: 'Відсоток знижки', de: 'Rabatt in Prozent', es: "Porcentaje de descuento" },
  'Исходная цена': { en: 'Original price', uk: 'Початкова ціна', de: 'Ursprünglicher Preis', es: "Precio original" },
  'Результат': { en: 'Result', uk: 'Результат', de: 'Ergebnis', es: "Resultado" },
  'Курс': { en: 'Rate', uk: 'Курс', de: 'Wechselkurs', es: "Tipo de cambio" },
  'Из': { en: 'From', uk: 'З', de: 'Von', es: "De" },
  'В': { en: 'To', uk: 'У', de: 'Nach', es: "A" },
  'Тип курса': { en: 'Rate type', uk: 'Тип курсу', de: 'Art des Kurses', es: "Tipo de referencia" },
  'Дата курса': { en: 'Rate date', uk: 'Дата курсу', de: 'Kursdatum', es: "Fecha del tipo" },
  'Дата обновления': { en: 'Update date', uk: 'Дата оновлення', de: 'Stand vom', es: "Fecha de actualización" },
  'Статус обновления': { en: 'Update status', uk: 'Статус оновлення', de: 'Stand der Aktualisierung', es: "Estado de la actualización" },
  'Последняя попытка обновления': { en: 'Last update attempt', uk: 'Остання спроба оновлення', de: 'Letzter Aktualisierungsversuch', es: "Último intento de actualización" },
  'Источник': { en: 'Source', uk: 'Джерело', de: 'Quelle', es: "Fuente" },
  'Резервный источник': { en: 'Fallback source', de: 'Ersatzquelle', uk: 'Резервне джерело', es: "Fuente de reserva" },
  ...
  'Количество рулонов': { en: 'Rolls needed', uk: 'Кількість рулонів', de: 'Anzahl der Rollen', es: "Número de rollos" },
  'Площадь стен': { en: 'Wall area', uk: 'Площа стін', de: 'Wandfläche', es: "Superficie de las paredes" },
  'Периметр': { en: 'Perimeter', uk: 'Периметр', de: 'Umfang', es: "Perímetro" },
  'Количество полотен': { en: 'Strips needed', uk: 'Кількість полотен', de: 'Anzahl der Bahnen', es: "Número de tiras" },
  'Полотен из рулона': { en: 'Strips per roll', uk: 'Полотен із рулону', de: 'Bahnen je Rolle', es: "Tiras por rollo" },
  'Запас': { en: 'Reserve', uk: 'Запас', de: 'Reserve', es: "Reserva" },
  'Заданный запас': { en: 'Added reserve', uk: 'Доданий запас', de: 'Gewählte Reserve', es: "Margen indicado" },
  'Остаток из-за целых банок': { en: 'Remainder from full cans', uk: 'Залишок через цілі банки', de: 'Rest durch ganze Dosen', es: "Sobrante por los botes enteros" },
  'Литры краски': { en: 'Paint liters', uk: 'Літри фарби', de: 'Farbe in Litern', es: "Litros de pintura" },
  'Площадь окрашивания': { en: 'Paint area', uk: 'Площа фарбування', de: 'Zu streichende Fläche', es: "Superficie a pintar" },
  'Слоёв': { en: 'Coats', uk: 'Шарів', de: 'Anstriche', es: "Manos" },
  'Количество банок': { en: 'Cans needed', uk: 'Кількість банок', de: 'Anzahl der Dosen', es: "Número de botes" },
  'Площадь пола': { en: 'Floor area', uk: 'Площа підлоги', de: 'Bodenfläche', es: "Superficie del suelo" },
  'Площадь упаковки': { en: 'Pack coverage', uk: 'Площа упаковки', de: 'Fläche eines Pakets', es: "Superficie del paquete" },
  ...
  'Объём раствора': { en: 'Mortar volume', uk: 'Об’єм розчину', de: 'Estrichvolumen', es: "Volumen de mortero" },
  'Толщина слоя': { en: 'Layer thickness', uk: 'Товщина шару', de: 'Schichtdicke', es: "Espesor de la capa" },
  'Сухая смесь': { en: 'Dry mix', uk: 'Суха суміш', de: 'Trockenmischung', es: "Mezcla seca" },
  'Мешков': { en: 'Bags', uk: 'Мішків', de: 'Säcke', es: "Sacos" },
  'Стоимость смеси': { en: 'Dry mix cost', uk: 'Вартість суміші', de: 'Kosten der Trockenmischung', es: "Coste de la mezcla" },
  'Цена продажи': { en: 'Selling price', uk: 'Ціна продажу', de: 'Verkaufspreis', es: "Precio de venta" },
  'Себестоимость': { en: 'Cost', uk: 'Собівартість', de: 'Selbstkosten', es: "Coste" },
  'Прибыль с единицы': { en: 'Profit per unit', uk: 'Прибуток з одиниці', de: 'Gewinn je Einheit', es: "Beneficio por unidad" },
  'Наценка': { en: 'Markup', uk: 'Націнка', de: 'Aufschlag', es: "Marcado" },
  'Маржа': { en: 'Margin', uk: 'Маржа', de: 'Marge', es: "Margen" },
  'Прибыль за партию': { en: 'Profit for the batch', uk: 'Прибуток за партію', de: 'Gewinn der Partie', es: "Beneficio del lote" },
  ...
  'Последний платеж': { en: 'Final payment', uk: 'Останній платіж', de: 'Letzte Rate', es: "Última cuota" },
  'Средний платеж': { en: 'Average payment', uk: 'Середній платіж', de: 'Durchschnittliche Rate', es: "Cuota media" },
  'Первоначальный взнос': { en: 'Down payment', uk: 'Перший внесок', de: 'Anzahlung', es: "Entrada" },
  'График первых платежей': { en: 'Payment schedule', uk: 'Графік платежів', de: 'Plan der ersten Raten', es: "Cuadro de las primeras cuotas" },
  'Месяц': { en: 'Month', uk: 'Місяць', de: 'Monat', es: "Mes" },
  'Платеж': { en: 'Payment', uk: 'Платіж', de: 'Rate', es: "Cuota" },
  'Основной долг': { en: 'Principal', uk: 'Основний борг', de: 'Tilgung', es: "Capital amortizado" },
  'Проценты': { en: 'Interest', uk: 'Відсотки', de: 'Zinsen', es: "Intereses" },
  'Остаток': { en: 'Balance', uk: 'Залишок', de: 'Restschuld', es: "Pendiente" },
  ...
  'Стоимость обоев': { en: 'Wallpaper cost', uk: 'Вартість шпалер', de: 'Kosten der Tapeten', es: "Coste del papel pintado" },
  'Стоимость краски': { en: 'Paint cost', uk: 'Вартість фарби', de: 'Kosten der Farbe', es: "Coste de la pintura" },
  'Ориентировочная стоимость': { en: 'Estimated cost', uk: 'Орієнтовна вартість', de: 'Ungefähre Kosten', es: "Coste aproximado" },
  'Плановый платеж с доплатой': { en: 'Planned payment with extra', uk: 'Плановий платіж із доплатою', de: 'Rate samt Sondertilgung', es: "Cuota prevista con amortización adicional" },
  'Разовая комиссия': { en: 'One-time fee', uk: 'Разова комісія', de: 'Einmalige Gebühr', es: "Comisión única" },
  'Сокращение срока': { en: 'Term reduction', uk: 'Скорочення строку', de: 'Verkürzung der Laufzeit', es: "Reducción del plazo" },
  'Расход в месяц со страховкой': { en: 'Monthly cost with insurance', uk: 'Щомісячні витрати зі страхуванням', de: 'Monatliche Ausgabe samt Versicherung', es: "Gasto mensual con seguro" },
  'Страховка и расходы за срок': { en: 'Insurance and costs over the term', uk: 'Страхування та витрати за весь строк', de: 'Versicherung und Kosten über die Laufzeit', es: "Seguro y gastos del plazo" },
  ...
  'Динамика по годам': { en: 'Year-by-year growth', uk: 'Динаміка за роками', de: 'Entwicklung nach Jahren', es: "Evolución por años" },
  'Год': { en: 'Year', uk: 'Рік', de: 'Jahr', es: "Año" },
  'Капитал': { en: 'Balance', uk: 'Капітал', de: 'Kapital', es: "Capital" },
  'Внесено': { en: 'Contributed', uk: 'Внесено', de: 'Eingezahlt', es: "Aportado" },
  ...
  'Дополнительная скидка': { en: 'Additional discount', uk: 'Додаткова знижка', de: 'Zusätzlicher Rabatt', es: "Descuento adicional" },
  'Итого за товары': { en: 'Total for all items', uk: 'Разом за всі товари', de: 'Summe für die Artikel', es: "Total de los artículos" },
