...
export const resultPhrases: Record<string, Partial<Record<Locale, string>>> = {
  ...
  'официальный справочный': { en: 'official reference rate', de: 'amtlicher Referenzkurs', uk: 'офіційний довідковий', es: "oficial de referencia" },
  'Это не курс в реальном времени. Используются официальные справочные курсы центральных банков на указанную дату. Банки и обменные пункты могут использовать другие курсы и комиссии.': { en: 'These are not real-time rates. The calculation uses official central-bank reference rates for the displayed date. Banks and exchange services may use different rates and fees.', de: 'Das sind keine Echtzeitkurse. Verwendet werden die amtlichen Referenzkurse der Zentralbanken zum angezeigten Datum. Banken und Wechselstuben können andere Kurse und Gebühren ansetzen.', uk: 'Це не курс у реальному часі. Розрахунок використовує офіційні довідкові курси центральних банків на вказану дату. Банки та обмінні сервіси можуть застосовувати інші курси й комісії.', es: "Estos no son tipos en tiempo real. El cálculo usa los tipos de referencia oficiales de los bancos centrales para la fecha mostrada. Los bancos y las casas de cambio pueden aplicar otros tipos y comisiones." },
  'Курсы успешно обновлены при последней сборке сайта.': { en: 'Rates were updated successfully during the latest site build.', de: 'Die Kurse wurden beim letzten Bau der Website erfolgreich aktualisiert.', uk: 'Курси успішно оновлено під час останнього складання сайту.', es: "Los tipos se actualizaron correctamente en la última compilación del sitio." },
  'Дата курса старше четырёх дней. Данные могут быть устаревшими.': { en: 'The reference-rate date is more than four days old. The data may be stale.', de: 'Das Kursdatum liegt mehr als vier Tage zurück. Die Daten können veraltet sein.', uk: 'Дата довідкового курсу старша за чотири дні. Дані можуть бути застарілими.', es: "La fecha del tipo tiene más de cuatro días. Los datos pueden estar desfasados." },
  'Не удалось обновить курсы при последней сборке. Используются последние сохранённые данные.': { en: 'The latest build could not update the rates. The last saved data is being used.', de: 'Beim letzten Bau ließen sich die Kurse nicht aktualisieren. Verwendet werden die zuletzt gespeicherten Daten.', uk: 'Під час останнього складання не вдалося оновити курси. Використовуються останні збережені дані.', es: "La última compilación no pudo actualizar los tipos. Se usan los últimos datos guardados." },
