...
// Идентификатор категории выводится из модулей категорий, а не перечисляется
// здесь. Раньше добавление категории начиналось с правки этого union: теперь
// достаточно создать директорию, и тип обновит генератор. Импорт типовой,
// поэтому цикла во время выполнения не возникает.
import type { CategoryId } from '../categories/manifest.generated';
