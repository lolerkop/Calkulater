...
export const localization: CalculatorLocalization = {
  ...
  es: {
    fields: {
      ...
      "width": "Ancho, px",
      "height": "Alto, px",
      "ratioW": "Ancho de la relación",
      "ratioH": "Alto de la relación",
      "known": "Lado conocido",
      "side": "Valor del lado conocido, px",
    },
    options: {
      "reduce": "relación a partir de una resolución",
      "side": "lado que falta a partir de una relación",
      "width": "ancho",
      "height": "alto",
    },
    results: {
      "Соотношение сторон": "Relación de aspecto",
      "Десятичное отношение": "Relación decimal",
      "Наибольший общий делитель": "Máximo común divisor",
      "Ближайшее распространённое": "Relación habitual más cercana",
      "Всего пикселей": "Píxeles en total",
      "Высота": "Alto",
      "Ширина": "Ancho",
      "Точное значение": "Valor exacto",
      "Разрешение": "Resolución",
    ...
    values: {
      ...
      "Обе части соотношения должны быть больше нуля": "Ambas partes de la relación deben ser mayores que cero",
