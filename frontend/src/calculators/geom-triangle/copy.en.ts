...
export const geomTriangleCopyEn: CalculatorCopy = {
  ...
  faq: [
    { q: "Why are some sets of sides rejected?", a: "Three segments form a triangle only when any two of them are longer than the third. Sides of 1, 2 and 3 lie on a straight line — there is no figure, and its area is undefined rather than zero." },
