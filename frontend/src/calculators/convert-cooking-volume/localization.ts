...
export const localization: CalculatorLocalization = {
  ...
  es: {
    ...
    options: {
      "ml": "Mililitro (ml)",
      "l": "Litro (l)",
      "tspM": "Cucharadita, métrica (5 ml)",
      "tbspM": "Cucharada, métrica (15 ml)",
      "cupM": "Taza, métrica (250 ml)",
      "tspUS": "Cucharadita, EE. UU.",
      "tbspUS": "Cucharada, EE. UU.",
      "cupUS": "Taza, EE. UU.",
      "flozUS": "Onza líquida, EE. UU.",
    },
    results: {
      "Результат": "Resultado",
    ...
    values: {
      ...
      "мл": "ml",
      "ч. л. (метр.)": "cdta. (métrica)",
      "ст. л. (метр.)": "cda. (métrica)",
      "стакан (метр.)": "taza (métrica)",
      "ч. л. (US)": "cdta. (EE. UU.)",
      "ст. л. (US)": "cda. (EE. UU.)",
      "стакан (US)": "taza (EE. UU.)",
      "жидк. унция (US)": "fl oz (EE. UU.)",
    },
  },
};
