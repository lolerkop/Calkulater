...
export const localization: CalculatorLocalization = {
  ...
  es: {
    ...
    results: {
      ...
      "Доля переплаты": "Los intereses como parte de la deuda",
      "Первый месяц: проценты": "Primer mes: intereses",
      "Первый месяц: тело долга": "Primer mes: capital",
      "График погашения": "Cuadro de amortización",
      "Месяц": "Mes",
      "Платёж": "Cuota",
      "Проценты": "Intereses",
    ...
    values: {
      ...
      "Платёж должен быть больше нуля": "La cuota debe ser mayor que cero",
      "Платёж не покрывает даже процент — долг не убывает": "La cuota no cubre ni los intereses: el saldo no baja",
      "Срок превышает 600 месяцев — увеличьте платёж": "El plazo supera los 600 meses: sube la cuota",
    },
  },
};
