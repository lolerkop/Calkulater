...
export const localization: CalculatorLocalization = {
  ...
  es: {
    ...
    values: {
      ...
      "Для этого уровня нужно не меньше четырёх дисков": "Este nivel necesita al menos cuatro discos",
      "ТБ": "TB",
      "без избыточности": "sin redundancia",
      "зеркало": "espejo",
      "чётность": "paridad",
      "двойная чётность": "doble paridad",
      "зеркало с чередованием": "espejo con reparto",
