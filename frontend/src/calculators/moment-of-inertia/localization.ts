...
export const localization: CalculatorLocalization = {
  ...
  es: {
    fields: {
      "shape": "Cuerpo",
      "m": "Masa, kg",
      "r": "Radio o longitud, m",
    },
    options: {
      "rod-center": "barra respecto a su centro",
      "rod-end": "barra respecto a su extremo",
      "disk": "disco macizo",
      "ring": "aro delgado",
      "sphere-solid": "esfera maciza",
      "sphere-hollow": "esfera hueca",
    },
    results: {
      "Момент инерции": "Momento de inercia",
      "Масса": "Masa",
      "Размер": "Tamaño",
      "Радиус инерции": "Radio de giro",
      "Тело": "Cuerpo",
    ...
    values: {
      ...
      "кг": "kg",
      "м": "m",
      "стержень через центр": "barra respecto a su centro",
      "стержень через конец": "barra respecto a su extremo",
      "сплошной диск": "disco macizo",
      "тонкое кольцо": "aro delgado",
      "сплошной шар": "esfera maciza",
      "полая сфера": "esfera hueca",
      "Неизвестное тело": "Cuerpo desconocido",
      "Масса должна быть больше нуля": "La masa debe ser mayor que cero",
      "Размер должен быть больше нуля": "El tamaño debe ser mayor que cero",
    },
  },
};
