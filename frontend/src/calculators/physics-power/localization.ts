...
export const localization: CalculatorLocalization = {
  ...
  es: {
    ...
    results: {
      ...
      "Работа": "Trabajo",
      "Время": "Tiempo",
      "В метрических лошадиных силах": "En caballos de vapor",
    ...
    values: {
      ...
      "Мощность должна быть больше нуля, иначе время не определено": "La potencia debe ser mayor que cero; de lo contrario el tiempo queda indeterminado",
      "Мощность не может быть отрицательной": "La potencia no puede ser negativa",
    },
  },
};
