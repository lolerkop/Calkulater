...
export const waterIntakeReferenceCases: readonly CalculatorReferenceCase[] = [
  {
    ...
    inputs: {"activityMinutes": 45, "hotWeather": false, "weight": 72},
  ...
  },
  {
    ...
    inputs: {"activityMinutes": 90, "hotWeather": true, "weight": 58},
  ...
  {
    name: "без нагрузки",
    inputs: {"activityMinutes": 0, "hotWeather": false, "weight": 80},
  ...
  },
  {
    ...
    inputs: {"activityMinutes": 30, "hotWeather": false, "weight": 0},
    expectPrimary: "—",
  },
];
