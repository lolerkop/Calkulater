...
export const localization: CalculatorLocalization = {
  ...
  es: {
    fields: {
      ...
      "sides": "Lados de la base",
      "side": "Longitud del lado de la base",
    ...
    results: {
      ...
      "Периметр основания": "Perímetro de la base",
    ...
    values: {
      ...
      "см³": "cm³",
      "м³": "m³",
      "Число сторон основания должно быть целым": "El número de lados de la base debe ser entero",
      "Сторон основания должно быть не меньше трёх": "La base debe tener al menos tres lados",
