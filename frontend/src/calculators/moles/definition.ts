...
export const definition: CalculatorDefinitionV2 = {
  ...
  publishedExample: { inputs: { mode: 'mass', mass: 18, molarMass: 18.015 }, expected: ['0,9992 моль'] },
  presentation: {
    id: 'moles',
    ...
    fields: [
      ...
      { name: 'molarMass', label: 'Молярная масса, г/моль', type: 'number', defaultValue: 18.015, min: 0, step: 0.001 },
    ],
    ...
    example: '18 граммов воды при молярной массе 18,015 г/моль дают 0,9992 моль — чуть меньше одного моля.',
    faq: [
      ...
      { q: 'Почему 18 граммов воды — это не ровно один моль?', a: 'Потому что молярная масса воды 18,015, а не 18. Ровно моль дают 18,015 грамма; разница небольшая, но в расчёте она видна.' },
