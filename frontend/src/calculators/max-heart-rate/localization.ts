...
export const localization: CalculatorLocalization = {
  ...
  es: {
    ...
    results: {
      ...
      "Аэробная зона 70–80 %": "Zona aeróbica 70-80 %",
      "Жиросжигающая зона 60–70 %": "Zona de quema de grasa 60-70 %",
      "Тренировочные зоны": "Zonas de entrenamiento",
      "Зона": "Zona",
    ...
    values: {
      ...
      "Аэробная": "Aeróbica",
      "Анаэробная": "Anaeróbica",
      "Максимальная": "Máxima",
      "Зоны посчитаны по резерву сердца: доля берётся от разности максимума и пульса покоя.": "Las zonas se calculan por reserva cardíaca: la proporción se toma de la diferencia entre el máximo y la frecuencia en reposo.",
      "Пульс покоя не задан, поэтому зоны — прямые доли максимального пульса.": "No se indicó la frecuencia en reposo, así que las zonas son proporciones directas de la frecuencia máxima.",
