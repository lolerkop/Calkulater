...
export const localization: CalculatorLocalization = {
  ...
  es: {
    fields: {
      ...
      "v2": "Tensión del secundario deseada, V",
      "i1": "Corriente del primario, A",
    },
    options: {
      "secondaryVoltage": "tensión del secundario",
      "turnsRatio": "relación de espiras",
    },
    results: {
      "Вторичное напряжение": "Tensión del secundario",
      "Отношение витков": "Relación de espiras",
      "Вторичный ток": "Corriente del secundario",
      "Мощность": "Potencia",
      "Тип": "Tipo",
    ...
    values: {
      ...
      "повышающий": "elevador",
      "понижающий": "reductor",
      "разделительный": "de aislamiento",
      "Первичное напряжение должно быть больше нуля": "La tensión del primario debe ser mayor que cero",
      "Первичный ток не может быть отрицательным": "La corriente del primario no puede ser negativa",
      "Вторичное напряжение должно быть больше нуля": "La tensión del secundario debe ser mayor que cero",
      "Число витков первичной обмотки должно быть больше нуля": "Las espiras del primario deben ser más de cero",
      "Число витков вторичной обмотки должно быть больше нуля": "Las espiras del secundario deben ser más de cero",
    },
  },
};
