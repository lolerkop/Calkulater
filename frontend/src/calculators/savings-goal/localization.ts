...
export const localization: CalculatorLocalization = {
  ...
  es: {
    ...
    options: {
      "payment": "Aportación mensual",
      "term": "Cuánto tarda",
    },
    results: {
      "Взнос в месяц": "Aportación mensual",
      "Срок": "Plazo",
      "В годах": "En años",
      "Месяцев": "Meses",
      "Всего взносов": "Aportaciones en total",
      "Начислено процентов": "Intereses generados",
    ...
    values: {
      "₽": "€",
      "мес": "mes",
      "Цель должна быть больше нуля": "El objetivo debe ser mayor que cero",
      "Начальная сумма не может быть отрицательной": "El importe inicial no puede ser negativo",
      "Ставка должна быть от 0 до 100 % годовых": "El tipo debe estar entre el 0 y el 100 % anual",
      "Ежемесячный взнос должен быть больше нуля": "La aportación mensual debe ser mayor que cero",
      "За сто лет цель не достигается: увеличьте взнос": "El objetivo no se alcanza en cien años: aumenta la aportación",
