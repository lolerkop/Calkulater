...
export const budgetReferenceCases: readonly CalculatorReferenceCase[] = [
  ...
  {
    // Половина от одного рубля — это 0,50 ₽. Прежнее ожидание «1 ₽» описывало
    // не расчёт, а округление вывода до целого: сумма меньше рубля вырастала
    // вдвое. Случай остаётся граничным, но проверяет теперь верное число.
