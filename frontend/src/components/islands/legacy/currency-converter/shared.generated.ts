...
// Общие фразы результата, отобранные под наследственный калькулятор currency-converter.
...
export const shared: CalculatorLocalization = {
  ...
  es: {
    ...
    values: {
      'официальный справочный': 'oficial de referencia',
      'Это не курс в реальном времени. Используются официальные справочные курсы центральных банков на указанную дату. Банки и обменные пункты могут использовать другие курсы и комиссии.': 'Estos no son tipos en tiempo real. El cálculo usa los tipos de referencia oficiales de los bancos centrales para la fecha mostrada. Los bancos y las casas de cambio pueden aplicar otros tipos y comisiones.',
      'Курсы успешно обновлены при последней сборке сайта.': 'Los tipos se actualizaron correctamente en la última compilación del sitio.',
      'Дата курса старше четырёх дней. Данные могут быть устаревшими.': 'La fecha del tipo tiene más de cuatro días. Los datos pueden estar desfasados.',
      'Не удалось обновить курсы при последней сборке. Используются последние сохранённые данные.': 'La última compilación no pudo actualizar los tipos. Se usan los últimos datos guardados.',
