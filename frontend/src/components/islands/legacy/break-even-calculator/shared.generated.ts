...
// Общие фразы результата, отобранные под наследственный калькулятор break-even-calculator.
...
export const shared: CalculatorLocalization = {
  ...
  de: {
    results: {
      ...
      'Выручка при плане продаж': 'Umsatz bei der geplanten Menge',
      'Маржинальная прибыль при плане': 'Deckungsbeitrag bei der geplanten Menge',
      'Прибыль при плане': 'Gewinn bei der geplanten Menge',
