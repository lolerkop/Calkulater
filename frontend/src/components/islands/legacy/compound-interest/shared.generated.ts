...
// Общие фразы результата, отобранные под наследственный калькулятор compound-interest.
...
export const shared: CalculatorLocalization = {
  ...
  de: {
    results: {
      ...
      'Прибыль': 'Gewinn',
      'В': 'Nach',
      'Динамика по годам': 'Entwicklung nach Jahren',
      'Год': 'Jahr',
      'Капитал': 'Kapital',
      'Внесено': 'Eingezahlt',
    },
  ...
  es: {
    results: {
      ...
      'Внесённая сумма': 'Importe aportado',
      'Прибыль': 'Beneficio',
      'В': 'A',
      'Динамика по годам': 'Evolución por años',
      'Год': 'Año',
      'Капитал': 'Capital',
      'Внесено': 'Aportado',
    },
