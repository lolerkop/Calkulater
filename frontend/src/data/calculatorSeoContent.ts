...
const formulaHints: Record<string, Record<string, string>> = {
  ...
  currency: {
    ru: 'Валютная логика использует соотношение сохранённых справочных курсов. Источник и дата каждого курса указаны отдельно; коммерческий курс банка может отличаться.',
    en: 'Currency logic uses the ratio between saved reference rates. Each rate has its own source and date; a bank\'s buy or sell rate may differ.',
    uk: 'Валютна логіка використовує співвідношення збережених довідкових курсів. Джерело й дату кожного курсу зазначено окремо; курс банку може відрізнятися.',
  },
  sport: {
