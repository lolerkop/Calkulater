...
const canonicalPublishedExamples: PublishedExample[] = [
  ...
  { calculatorId: 'brick-calculator', locale: 'ru', source: '/ru/building/brick-calculator/', input: { mode: 'dimensions', wallLength: 6, wallHeight: 2.8, openingsArea: 0, unitLength: 250, unitHeight: 65, joint: 10, reserve: 5, unitPrice: 0 }, expected: ['905 шт.', '862 шт.'] },
