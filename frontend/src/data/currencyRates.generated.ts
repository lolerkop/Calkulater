...
export const generatedRateProvenance = {
  ...
  MDL: { provider: 'bnm', date: '2026-09-20', fallback: false },
} as const;

export const generatedRateSources = {
  bnm: { label: "National Bank of Moldova", url: 'https://www.bnm.md/en/official_exchange_rates', date: '2026-09-20', fallback: false },
