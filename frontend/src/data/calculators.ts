...
export const calculators: CalculatorDef[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'downPayment', label: 'Первоначальный взнос', type: 'number', defaultValue: 1600000, unit: '₽', min: 0 },
  ...
  // ── ВАЛЮТЫ ────────────────────────────────────────────────────────
  {
    ...
    longDescription:
      'Конвертер валют переводит суммы между USD, EUR, MDL, RON, UAH, PLN, GBP, CHF и TRY. Он удобен для быстрой прикидки бюджета поездки, покупки или перевода между валютами. Сейчас используются демонстрационные фиксированные курсы, поэтому перед реальной операцией нужно сверить актуальный курс в банке или обменнике.',
  ...
  },
  {
    ...
    longDescription:
      'Конвертер USD в EUR открывает общий валютный калькулятор уже с выбранной парой доллар США - евро. Страница подходит для быстрой оценки суммы в поездке, онлайн-покупке или личном переводе. Курс демонстрационный, поэтому финальный обмен лучше сверять с актуальными котировками банка.',
    seoTitle: 'USD в EUR онлайн — конвертер долларов в евро',
    seoDescription:
      'Перевод долларов США в евро онлайн: быстрый расчёт USD/EUR по демонстрационному курсу для предварительной оценки суммы.',
    ...
    howItWorks: 'Расчёт выполняется через базовую таблицу курсов к USD. Для пары USD/EUR сумма умножается на демонстрационный коэффициент евро к доллару.',
  ...
  },
  {
    ...
    longDescription:
      'Конвертер EUR в MDL помогает быстро перевести евро в молдавские леи и понять примерный порядок суммы. Такая страница удобна для поездок, переводов, сравнения цен и планирования бюджета. Расчёт использует демонстрационные фиксированные курсы, а не официальный курс на текущий день.',
    seoTitle: 'EUR в MDL онлайн — конвертер евро в молдавский лей',
    seoDescription:
      'Перевод евро в молдавские леи онлайн: быстрый расчёт EUR/MDL по демонстрационному курсу для поездок и переводов.',
    ...
    howItWorks: 'EUR конвертируется в USD, затем USD - в MDL по таблице демонстрационных курсов. Такой подход позволяет использовать одну базовую таблицу для всех валютных пар.',
    ...
    faq: [
      ...
      { q: 'Почему курс называется демонстрационным?', a: 'Он зафиксирован в данных сайта для работы калькулятора без внешнего API и может не совпадать с рынком.' },
    ],
  ...
  },
  {
    ...
    longDescription:
      'Конвертер USD в MDL переводит доллары США в молдавские леи с уже выбранной валютной парой. Он помогает быстро оценить сумму для поездки, покупки, перевода или сравнения цен. Используется демонстрационный курс, поэтому для финансового решения обязательно проверьте актуальный курс банка.',
    seoTitle: 'USD в MDL онлайн — конвертер долларов в молдавский лей',
    seoDescription:
      'Перевод долларов США в молдавские леи онлайн: быстрый расчёт USD/MDL по демонстрационному курсу для предварительной оценки.',
    ...
    howItWorks: 'Расчёт выполняется по таблице курсов к USD. Для USD/MDL сумма умножается на демонстрационный коэффициент молдавского лея к доллару.',
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'Можно ли считать шестидневную рабочую неделю?', a: 'Отдельного режима шестидневки пока нет. Для нестандартного графика используйте исключения и проверяйте результат вручную.' },
