...
export const ratesStatus = ratesUpdateFailed
  ? 'Последняя проверка источников не удалась. Используются последние сохранённые курсы.'
  : ratesAreStale
    ? 'Курсы одного или нескольких источников могут быть устаревшими. Проверьте даты источников.'
    : ratesUsedFallback
      ? 'Сохранённые курсы проверены; часть валют получена из резервного источника.'
      : 'Сохранённые курсы прошли последнюю проверку источников.';

export const ratesNotice =
  'Это не курс в реальном времени. Используются сохранённые справочные курсы указанных источников; резервный источник отмечен отдельно. Банки и обменные пункты могут использовать другие курсы и комиссии.';
