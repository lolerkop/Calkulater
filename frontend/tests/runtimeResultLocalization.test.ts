...
describe('runtime result localization: остальные опубликованные калькуляторы', () => {
  ...
  const PRE_EXISTING_EN = [
    'Enter positive dimensions и толщину',            // screed-calculator, смешанная строка
    'Вес мешка должен быть больше нуля',              // screed-calculator
    'Введите себестоимость больше нуля',              // margin-calculator
    'Цена продажи ниже себестоимости, поэтому наценка и маржа отрицательные.', // margin-calculator
    'Введите цену больше нуля',                       // discount-calculator
    'Выберите исходную дату',                         // date-shift-calculator
    'Сумма кредита должна быть положительной',        // mortgage-calculator
  ];
  const PRE_EXISTING_UK = [
    'Вес мешка должен быть больше нуля',
    'Введите себестоимость больше нуля',
